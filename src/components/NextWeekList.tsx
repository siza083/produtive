...
export function NextWeekList() {
  const { data: tasks, isLoading } = useNextWeekTasks();
    ...
    return (
      <Card>
        ...
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <h3 className="text-lg font-medium mb-2">Próxima semana livre! 📅</h3>
          <p className="text-muted-foreground text-center">
            Você não tem atividades atribuídas para a próxima semana.
          </p>
        </CardContent>
      </Card>
    );
